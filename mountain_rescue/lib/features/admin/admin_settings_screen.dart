...
class _AdminSettingsScreenState extends ConsumerState<AdminSettingsScreen> {
  ...
  Future<void> _exportAdminReport() async {
    ...
    final rescuerCount =
        (await firestore.collection('users').where('role', isEqualTo: 'rescuer').get())
            .docs
            .length;
    final injuryCount = (await firestore.collection('injuries').get()).docs.length;

    final reportData = {
      'Admin Name': user.displayName ?? 'N/A',
      ...
      pw.Page(
        ...
        build: (context) => pw.Padding(
          ...
          child: pw.Column(
            ...
            children: [
              pw.Text('Mountain Rescue - Admin Report',
                  style: pw.TextStyle(
                    fontSize: 24,
          ...
          child: ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text('Export System Report (PDF)',
                    style: TextStyle(color: Colors.white)),
